...
(* OASIS_START *)
(* DO NOT EDIT (digest: eb7aea949e934f05ccc3218217954141) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Bootvar"; "Parse_argv"];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "mirage-bootvar";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\192D\247\172{\232\157n\129\217\166$\"\210~p";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
